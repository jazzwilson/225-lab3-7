pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/wilso682'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/jazzwilson/225-lab3-7'                                    //<------your MiamiID
        KUBECONFIG = credentials('wilso682-225')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.229.150 \
